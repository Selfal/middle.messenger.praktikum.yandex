...
export class Home extends Block {
  ...
  render() {
    const component = pug.compile(`div.home.wrapper
        div.chat-menu
          div.chat-menu__header
            ...
            a.button-only-icon.button--add(href="../profileSetting/index.html")
    ...
    const dialogsPreview = this.props.childComponents.dialogsPreview;
    const messages = this.props.childComponents.messages;
